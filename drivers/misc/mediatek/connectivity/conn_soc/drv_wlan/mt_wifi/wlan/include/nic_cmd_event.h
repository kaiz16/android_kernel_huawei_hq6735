...
typedef enum _ENUM_CMD_ID_T {
    ...
    CMD_ID_GET_PSCAN_CAPABILITY,        /* 0x42 (Get) */
    CMD_ID_SET_PSCN_ENABLE,            /* 0x43 (Set) */
    CMD_ID_SET_PSCAN_PARAM,             /* 0x44 (Set) */
    CMD_ID_SET_PSCN_ADD_HOTLIST_BSSID, /* 0x45 (Set) */
    CMD_ID_SET_PSCN_ADD_SW_BSSID,     /* 0x46 (Set) */ //SWC: Significant Wifi Change
    CMD_ID_SET_PSCN_MAC_ADDR,          /* 0x47 (Set) */
    CMD_ID_GET_GSCN_SCN_RESULT,            /* 0x48 (Query) */
...
typedef struct _CMD_RLM_BCN_INFO_T {
	...
	BOOLEAN		u4BcnTT_fgKeepAwakeInLastStage;
