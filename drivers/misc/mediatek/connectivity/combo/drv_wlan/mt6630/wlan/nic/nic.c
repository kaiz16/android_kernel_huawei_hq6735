...
nicGetChipEcoVer() 
{
    ...
    DBGLOG(INIT, INFO, ("Cannot get ECO version for SwVer[0x%02x]" 
        "HwVer[0x%02x] FactoryVer[0x%1x], recognize as latest version [E%u]\n", 
