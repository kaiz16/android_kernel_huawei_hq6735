	...
	do {
		...
		/* <2> Special case for access Driver Domain MCR */
			...
			if (prCmdInfo->fgSetQuery) {
				HAL_MCR_WR(prAdapter, (unsigned)(prCmdAccessReg->u4Address & BITS(2, 31)),	/* address is in DWORD unit */
				...
				HAL_MCR_RD(prAdapter, (unsigned)(prEventAccessReg->u4Address & BITS(2, 31)),	/* address is in DWORD unit */
