...
static imgsensor_info_struct imgsensor_info = { 
    ...
    .pre = {
        .pclk = 36000000,              //record different mode's pclk //21
...
static void set_max_framerate(UINT16 framerate,kal_bool min_framelength_en)
{
    ...
    LOG_INF("Enter framerate = %d, min framelength should enable? \n", framerate,min_framelength_en);
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x2f,0x0c); //pll clk 60M            
	write_cmos_sensor(0xfd,0x01);
	write_cmos_sensor(0x03,0x03); //exp time, 3 base
	write_cmos_sensor(0x04,0xa2);
	...
	write_cmos_sensor(0x00,0x9a);
	write_cmos_sensor(0x01,0x9a);
	write_cmos_sensor(0x03,0x9a);
	write_cmos_sensor(0x04,0x9a);
