...
*
********************************************************************************/
#define CAM_CAL_DRVNAME "HI843B808OTP"
...
// OTP Flag Read
    write_HynixOtp_sensor_16(0x70a, 0x0C90); // Set Address 
...
// Bank Select 
    switch(Bank_No)
    {
        case 1: Start_Add = 0x0C91; 
            break ;
        case 3: Start_Add = 0x0C98; 
            break;
        case 7: Start_Add = 0x0C9f; 
            break;
        default : // Error .. 
