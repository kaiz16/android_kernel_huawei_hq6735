...
static imgsensor_info_struct imgsensor_info = { 
	...
	.checksum_value = 0xdf1036f9,		//checksum value for Camera Auto Test
	.pre = {
	...
	.margin = 6,			//sensor framelength & shutter margin old:4 update by Yajun
	.min_shutter = 6,		//min shutter old:4 update by Yajun
			...
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if((read_cmos_sensor(0x302A)) == 0XB0){
					...
					printk("lili>>>i2c write id: 0x%x, sensor id: 0x%x, ov8855version = %d(0=r2a,1=r1a)\n", imgsensor.i2c_write_id,*sensor_id,ov8855version);				
					return ERROR_NONE;
				}
