...
static void ihdr_write_shutter_gain(kal_uint16 le, kal_uint16 se, kal_uint16 gain)
{
	...
	se = le / 4;   // \B3\A4\C6?\E2ʱ\BC\E4\CAǶ\CC\C6?\E2ʱ\BC\E48\B1\B6
#if 1    
...
{
//ExtcClk	                                                     24	MHz	     
//VT pixel clk	                                               280	MHz	   
//MIPI Lane system clk	                                       700	MHz	2BC
//Number of Lane	                                             4	lane	   
//IM_Width	                                                   474	px	   
//IM_Height	                                                   1275	px	   
//Width	                                                       1632	px	   
//Height	                                                     1224	px	   
//x_addr_start : multiple of 4(Binning?)	                     8		       
//x_addr_end : multiple of 4 + 1 (x_addr_end \A1\DC3277d)(Binning?) 3271	4n+3	 	
//y_addr_start : even number(Binning?)	                       8		       
//y_addr_end : odd number (y_addr_end \A1\DC2461d)(Binning?)	       2455		     
//Frame rate	                                                 29.9	fps	   
//Integration time	                                           30.9	mS	   
//Output format	                                               Raw10		   
...
{
//ExtcClk	                                                      24	MHz	    
//VT pixel clk	                                                140	MHz	    
//MIPI Lane system clk	                                        560	MHz	230 
//Number of Lane	                                              4	lane	    
//IM_Width	                                                    474	px	    
//IM_Height	                                                    45	px	    
//Width	                                                        3264	px	  
...
write_cmos_sensor(0x6F12, 0x0140);
write_cmos_sensor(0xFCFC, 0x4000);
write_cmos_sensor(0x0200, 0x0800);
...
//y_addr_start : even number(Binning?)	                       8		       
//y_addr_end : odd number (y_addr_end \A1\DC2461d)(Binning?)	       2455		     
//Frame rate	                                                 116.9	fps	 
//Integration time	                                           15.0	mS	   
//Output format	                                               
...
//ExtcClk	                                                     24	MHz	     
//VT pixel clk	                                               280	MHz	   
//MIPI Lane system clk	                                       642	MHz	282
//Number of Lane	                                             4	lane	   
//IM_Width	                                                   826	px	   
//IM_Height	                                                   1773	px	   
//Width	                                                       1280	px	   
//Height	                                                     720	px	   
//x_addr_start : multiple of 4(Binning?)	                     360		     
//x_addr_end : multiple of 4 + 1 (x_addr_end \A1\DC3277d)(Binning?) 2919	4n+3	  
//y_addr_start : even number(Binning?)	                       512		     
//y_addr_end : odd number (y_addr_end \A1\DC2461d)(Binning?)	       1951		      
//Frame rate	                                                 30.0	fps	   
//Integration time	                                           15.0	mS	   
//Output format	                                               Raw10		   
...
write_cmos_sensor(0x030E, 0x00AF);
write_cmos_sensor(0x3008, 0x0000);
write_cmos_sensor(0x317A, 0x0103);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	//if(S5K4H5YC_read_otp(&otp_ptr) != 0){
//		S5K4H5YC_write_otp(&otp_ptr);		
//	}
#endif
