...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .linelength = 1114,                //record different mode's linelength
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x06,0x16);//34c
	write_cmos_sensor(0x07,0x00);
	write_cmos_sensor(0x08,0x18);//12
	...
	write_cmos_sensor(0xe5,0xff);  //add jeff 2015.11.27
