...
UINT32 OV8865_SUNNY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //Add for al912 , libin
...
#endif
#if defined(OV8865_SUNNY_MIPI_RAW) //Add for al912 , libin
    {OV8865_SUNNY_SENSOR_ID, SENSOR_DRVNAME_OV8865_SUNNY_MIPI_RAW,OV8865_SUNNY_MIPI_RAW_SensorInit},
#endif
