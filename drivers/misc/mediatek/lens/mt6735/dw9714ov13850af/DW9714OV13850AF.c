...
#define AF_DRVNAME "DW9714OV13850AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x18
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9714ov13850af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9714ov13850af"

static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO(AF_DRVNAME, 0x20)};
...
inline static int getAFInfo(__user stDW9714OV13850AF_MotorInfo * pstMotorInfo)
{
    stDW9714OV13850AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stDW9714OV13850AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9714OV13850AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stDW9714OV13850AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stDW9714OV13850AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9714OV13850AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9714OV13850AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9714OV13850AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9714OV13850AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case DW9714OV13850AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case DW9714OV13850AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case DW9714OV13850AFIOC_T_SETMACROPOS :
...
LOG_INF("liyongjian>>>[DW9714] DW9714OV13850AF I2C send successful; i4RetValue = %d\n",i4RetValue);
...
static int __init DW9714OV13850AF_i2C_init(void)
{
...
static void __exit DW9714OV13850AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(DW9714OV13850AF_i2C_init);
module_exit(DW9714OV13850AF_i2C_exit);

MODULE_DESCRIPTION("DW9714OV13850AF lens module driver");
