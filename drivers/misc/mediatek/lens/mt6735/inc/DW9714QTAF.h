...
#define DW9714QTAFIOC_T_MOVETO _IOW(DW9714QTAF_MAGIC, 1, u32)

#define DW9714QTAFIOC_T_SETINFPOS _IOW(DW9714QTAF_MAGIC, 2, u32)

#define DW9714QTAFIOC_T_SETMACROPOS _IOW(DW9714QTAF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define DW9714QTAFIOC_G_MOTORMETAINFO _IOR(DW9714QTAF_MAGIC, 4, stDW9714QTAF_MotorMETAInfo)
#endif
