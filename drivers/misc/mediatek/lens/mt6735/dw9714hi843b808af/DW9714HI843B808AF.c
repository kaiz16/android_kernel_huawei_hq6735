...
#define AF_DRVNAME "DW9714HI843B808AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x30
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9714hi843b808af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9714hi843b808af"
...
inline static int getAFInfo(__user stDW9714HI843B808AF_MotorInfo * pstMotorInfo)
{
    stDW9714HI843B808AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stDW9714HI843B808AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9714HI843B808AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stDW9714HI843B808AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stDW9714HI843B808AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9714HI843B808AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9714HI843B808AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9714HI843B808AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9714HI843B808AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case DW9714HI843B808AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case DW9714HI843B808AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case DW9714HI843B808AFIOC_T_SETMACROPOS :
...
char puSendCmd3[2]={(char)(0xF2),(char)(0x40)};// T_SRC[4:0] = 01000
...
static int __init DW9714HI843B808AF_i2C_init(void)
{
	printk("travies add for check AF init\n");
    i2c_register_board_info(LENS_I2C_BUSNUM, &kd_lens_dev, 1);
	printk("zjy_DW9714HI843B808AF_i2C_init!!!");
...
static void __exit DW9714HI843B808AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(DW9714HI843B808AF_i2C_init);
module_exit(DW9714HI843B808AF_i2C_exit);

MODULE_DESCRIPTION("DW9714HI843B808AF lens module driver");
