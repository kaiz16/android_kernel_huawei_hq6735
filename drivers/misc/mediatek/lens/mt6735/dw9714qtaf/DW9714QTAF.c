...
#define AF_DRVNAME "DW9714QTAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x18
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9714qtaf"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9714qtaf"
...
inline static int getAFInfo(__user stDW9714QTAF_MotorInfo * pstMotorInfo)
{
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9714QTAF_MotorMETAInfo * pstMotorMETAInfo)
{
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9714QTAFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9714QTAF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9714QTAFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9714QTAF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
