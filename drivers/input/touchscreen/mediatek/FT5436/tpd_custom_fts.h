...
#define CONFIG_HQ_CTP_FW_AUTO_UPGRADE_SW
#ifdef CONFIG_HQ_CTP_FW_AUTO_UPGRADE_SW			//ctl auto upgrate FW sw 20150707
...
#define FTS_GESTRUE
#define FTS_GESTURE_SYSFS_MODE
#endif
#define FTS_GESTURE_PROC_MODE
#define CFG_MAX_TOUCH_POINTS 5
