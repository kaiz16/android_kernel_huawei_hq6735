...
ifeq ($(ENABLE_MOVISTAR_ITSON), true)
	$(KERNEL_ROOT_DIR)/vendor/itson/arm/build-kernel.sh $(KERNEL_ROOT_DIR)/prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/arm-eabi- $(KERNEL_ROOT_DIR)/out/target/product/hq6735_35u_b1n_l1/obj/KERNEL_OBJ/
endif
